    ...
    <div class="panel panel-default floatLeft body-formulario">
        ...
        <div class="row default-padding" style="margin-top: 30px;">
            <div class="col-xs-12 floatLeft">
                <span style="font-weight: bold;">Dados do Comprovante => Data Compra: 25/06/2012 - Valor Compra: R$ 9,28 - CEP Compra: 40275-240</span>
            </div>
        ...
        <div class="row default-padding" style="margin-top: 30px;">
            <div class="col-xs-12 floatLeft">
                <span style="font-weight: bold;">Análise do retorno da OCR da imagem para saber se os dados do Comprovante estão corretos:</span>
            </div>
            <div class="col-xs-12 floatLeft" style="margin-top: 10px;">
